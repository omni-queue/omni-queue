...
Next.js + `@vasto/next-adapter` dashboard hosting sample.
...
```bash
npx @vasto/cli dashboard:publish --out=./public/vasto-dashboard --base=/api/dashboard-api --api-base=/api/dashboard-api
```
